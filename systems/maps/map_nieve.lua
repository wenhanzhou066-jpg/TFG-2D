-- systems/maps/map_nieve.lua  –  Mapa Nieve (STI + Tiled)
...
local KNOWN_TILESETS = {
    ...
    ["nieve_64.tsx"]  = "../../assets/maps/nieve/nieve_64.tsx",
    ["nieve_256.tsx"] = "../../assets/maps/nieve/nieve_256.tsx",
    ["nieve_128.tsx"] = "../../assets/maps/nieve/nieve_128.tsx",
}
...
local MAP_FILE = "systems/maps/mapa_black_steel_nieve.lua"
...
function Map.load()
    ...
    print(string.format(
        "[MapNieve] Cargado: %d walls, %d destructible, %d rivers, %d bridges, %d spawns, %d powerups",
